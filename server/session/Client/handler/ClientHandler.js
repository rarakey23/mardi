...
class ClientHandler {
	...
	async sendProduct({ image_url, title, body, footer, url, currencyCode, price, salePrice }) {
			...
			proto.Message.fromObject({
				productMessage: {
					product: {
						...
						productId: getIdProduct ? getIdProduct : "ilyasa",
						title: title ? title : "-",
						description: "",
						currencyCode: currencyCode ? currencyCode : "IDR",
						footerText: "",
						priceAmount1000: price ? price : "",
						productImageCount: 1,
						firstImageId: "123",
						salePriceAmount1000: salePrice ? salePrice : "",
						retailerId: "",
						url: "",
					},
					footer,
